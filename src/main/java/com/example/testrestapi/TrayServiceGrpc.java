...
public final class TrayServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.example.testrestapi.TrayService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.example.testrestapi.GetTrayRequest,
      com.example.testrestapi.GetTrayResponse> getGetTrayServiceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getTrayService",
      requestType = com.example.testrestapi.GetTrayRequest.class,
      responseType = com.example.testrestapi.GetTrayResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.testrestapi.GetTrayRequest,
      com.example.testrestapi.GetTrayResponse> getGetTrayServiceMethod() {
    io.grpc.MethodDescriptor<com.example.testrestapi.GetTrayRequest, com.example.testrestapi.GetTrayResponse> getGetTrayServiceMethod;
      ...
      synchronized (TrayServiceGrpc.class) {
        if ((getGetTrayServiceMethod = TrayServiceGrpc.getGetTrayServiceMethod) == null) {
          TrayServiceGrpc.getGetTrayServiceMethod = getGetTrayServiceMethod =
              io.grpc.MethodDescriptor.<com.example.testrestapi.GetTrayRequest, com.example.testrestapi.GetTrayResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getTrayService"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.testrestapi.GetTrayRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.testrestapi.GetTrayResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.testrestapi.CreateTrayRequest,
      com.example.testrestapi.CreateTrayResponse> getCreateTrayServiceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "createTrayService",
      requestType = com.example.testrestapi.CreateTrayRequest.class,
      responseType = com.example.testrestapi.CreateTrayResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.testrestapi.CreateTrayRequest,
      com.example.testrestapi.CreateTrayResponse> getCreateTrayServiceMethod() {
    io.grpc.MethodDescriptor<com.example.testrestapi.CreateTrayRequest, com.example.testrestapi.CreateTrayResponse> getCreateTrayServiceMethod;
      ...
      synchronized (TrayServiceGrpc.class) {
        if ((getCreateTrayServiceMethod = TrayServiceGrpc.getCreateTrayServiceMethod) == null) {
          TrayServiceGrpc.getCreateTrayServiceMethod = getCreateTrayServiceMethod =
              io.grpc.MethodDescriptor.<com.example.testrestapi.CreateTrayRequest, com.example.testrestapi.CreateTrayResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "createTrayService"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.testrestapi.CreateTrayRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.testrestapi.CreateTrayResponse.getDefaultInstance()))
  ...
  public static abstract class TrayServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getTrayService(com.example.testrestapi.GetTrayRequest request,
        io.grpc.stub.StreamObserver<com.example.testrestapi.GetTrayResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetTrayServiceMethod(), responseObserver);
    }

    /**
     */
    public void createTrayService(com.example.testrestapi.CreateTrayRequest request,
        io.grpc.stub.StreamObserver<com.example.testrestapi.CreateTrayResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.example.testrestapi.GetTrayRequest,
                com.example.testrestapi.GetTrayResponse>(
                  this, METHODID_GET_TRAY_SERVICE)))
          .addMethod(
            getCreateTrayServiceMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.example.testrestapi.CreateTrayRequest,
                com.example.testrestapi.CreateTrayResponse>(
  ...
  public static final class TrayServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<TrayServiceBlockingStub> {
    ...
    /**
     */
    public com.example.testrestapi.GetTrayResponse getTrayService(com.example.testrestapi.GetTrayRequest request) {
    ...
    /**
     */
    public com.example.testrestapi.CreateTrayResponse createTrayService(com.example.testrestapi.CreateTrayRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class TrayServiceFutureStub extends io.grpc.stub.AbstractFutureStub<TrayServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.testrestapi.GetTrayResponse> getTrayService(
        com.example.testrestapi.GetTrayRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.testrestapi.CreateTrayResponse> createTrayService(
        com.example.testrestapi.CreateTrayRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_TRAY_SERVICE:
          serviceImpl.getTrayService((com.example.testrestapi.GetTrayRequest) request,
              (io.grpc.stub.StreamObserver<com.example.testrestapi.GetTrayResponse>) responseObserver);
          break;
        case METHODID_CREATE_TRAY_SERVICE:
          serviceImpl.createTrayService((com.example.testrestapi.CreateTrayRequest) request,
              (io.grpc.stub.StreamObserver<com.example.testrestapi.CreateTrayResponse>) responseObserver);
          break;
        default:
