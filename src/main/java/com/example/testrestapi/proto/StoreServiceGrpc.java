...
public final class StoreServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.example.testrestapi.proto.StoreService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.example.testrestapi.proto.GetStoreRequest,
      com.example.testrestapi.proto.GetStoreResponse> getGetStoreServiceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getStoreService",
      requestType = com.example.testrestapi.proto.GetStoreRequest.class,
      responseType = com.example.testrestapi.proto.GetStoreResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.testrestapi.proto.GetStoreRequest,
      com.example.testrestapi.proto.GetStoreResponse> getGetStoreServiceMethod() {
    io.grpc.MethodDescriptor<com.example.testrestapi.proto.GetStoreRequest, com.example.testrestapi.proto.GetStoreResponse> getGetStoreServiceMethod;
      ...
      synchronized (StoreServiceGrpc.class) {
        if ((getGetStoreServiceMethod = StoreServiceGrpc.getGetStoreServiceMethod) == null) {
          StoreServiceGrpc.getGetStoreServiceMethod = getGetStoreServiceMethod =
              io.grpc.MethodDescriptor.<com.example.testrestapi.proto.GetStoreRequest, com.example.testrestapi.proto.GetStoreResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getStoreService"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.testrestapi.proto.GetStoreRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.testrestapi.proto.GetStoreResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.testrestapi.proto.CreateStoreRequest,
      com.example.testrestapi.proto.CreateStoreResponse> getCreateStoreServiceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "createStoreService",
      requestType = com.example.testrestapi.proto.CreateStoreRequest.class,
      responseType = com.example.testrestapi.proto.CreateStoreResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.testrestapi.proto.CreateStoreRequest,
      com.example.testrestapi.proto.CreateStoreResponse> getCreateStoreServiceMethod() {
    io.grpc.MethodDescriptor<com.example.testrestapi.proto.CreateStoreRequest, com.example.testrestapi.proto.CreateStoreResponse> getCreateStoreServiceMethod;
      ...
      synchronized (StoreServiceGrpc.class) {
        if ((getCreateStoreServiceMethod = StoreServiceGrpc.getCreateStoreServiceMethod) == null) {
          StoreServiceGrpc.getCreateStoreServiceMethod = getCreateStoreServiceMethod =
              io.grpc.MethodDescriptor.<com.example.testrestapi.proto.CreateStoreRequest, com.example.testrestapi.proto.CreateStoreResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "createStoreService"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.testrestapi.proto.CreateStoreRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.testrestapi.proto.CreateStoreResponse.getDefaultInstance()))
  ...
  public static abstract class StoreServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getStoreService(com.example.testrestapi.proto.GetStoreRequest request,
        io.grpc.stub.StreamObserver<com.example.testrestapi.proto.GetStoreResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetStoreServiceMethod(), responseObserver);
    }

    /**
     */
    public void createStoreService(com.example.testrestapi.proto.CreateStoreRequest request,
        io.grpc.stub.StreamObserver<com.example.testrestapi.proto.CreateStoreResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.example.testrestapi.proto.GetStoreRequest,
                com.example.testrestapi.proto.GetStoreResponse>(
                  this, METHODID_GET_STORE_SERVICE)))
          .addMethod(
            getCreateStoreServiceMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.example.testrestapi.proto.CreateStoreRequest,
                com.example.testrestapi.proto.CreateStoreResponse>(
  ...
  public static final class StoreServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<StoreServiceBlockingStub> {
    ...
    /**
     */
    public com.example.testrestapi.proto.GetStoreResponse getStoreService(com.example.testrestapi.proto.GetStoreRequest request) {
    ...
    /**
     */
    public com.example.testrestapi.proto.CreateStoreResponse createStoreService(com.example.testrestapi.proto.CreateStoreRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class StoreServiceFutureStub extends io.grpc.stub.AbstractFutureStub<StoreServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.testrestapi.proto.GetStoreResponse> getStoreService(
        com.example.testrestapi.proto.GetStoreRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.testrestapi.proto.CreateStoreResponse> createStoreService(
        com.example.testrestapi.proto.CreateStoreRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_STORE_SERVICE:
          serviceImpl.getStoreService((com.example.testrestapi.proto.GetStoreRequest) request,
              (io.grpc.stub.StreamObserver<com.example.testrestapi.proto.GetStoreResponse>) responseObserver);
          break;
        case METHODID_CREATE_STORE_SERVICE:
          serviceImpl.createStoreService((com.example.testrestapi.proto.CreateStoreRequest) request,
              (io.grpc.stub.StreamObserver<com.example.testrestapi.proto.CreateStoreResponse>) responseObserver);
          break;
        default:
