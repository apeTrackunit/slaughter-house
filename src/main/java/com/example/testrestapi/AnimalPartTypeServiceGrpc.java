...
public final class AnimalPartTypeServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.example.testrestapi.AnimalPartTypeService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.example.testrestapi.GetAnimalPartTypeRequest,
      com.example.testrestapi.GetAnimalPartTypeResponse> getGetAnimalPartTypeServiceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getAnimalPartTypeService",
      requestType = com.example.testrestapi.GetAnimalPartTypeRequest.class,
      responseType = com.example.testrestapi.GetAnimalPartTypeResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.testrestapi.GetAnimalPartTypeRequest,
      com.example.testrestapi.GetAnimalPartTypeResponse> getGetAnimalPartTypeServiceMethod() {
    io.grpc.MethodDescriptor<com.example.testrestapi.GetAnimalPartTypeRequest, com.example.testrestapi.GetAnimalPartTypeResponse> getGetAnimalPartTypeServiceMethod;
      ...
      synchronized (AnimalPartTypeServiceGrpc.class) {
        if ((getGetAnimalPartTypeServiceMethod = AnimalPartTypeServiceGrpc.getGetAnimalPartTypeServiceMethod) == null) {
          AnimalPartTypeServiceGrpc.getGetAnimalPartTypeServiceMethod = getGetAnimalPartTypeServiceMethod =
              io.grpc.MethodDescriptor.<com.example.testrestapi.GetAnimalPartTypeRequest, com.example.testrestapi.GetAnimalPartTypeResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getAnimalPartTypeService"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.testrestapi.GetAnimalPartTypeRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.testrestapi.GetAnimalPartTypeResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.testrestapi.CreateAnimalPartTypeRequest,
      com.example.testrestapi.CreateAnimalPartTypeResponse> getCreateAnimalPartTypeServiceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "createAnimalPartTypeService",
      requestType = com.example.testrestapi.CreateAnimalPartTypeRequest.class,
      responseType = com.example.testrestapi.CreateAnimalPartTypeResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.testrestapi.CreateAnimalPartTypeRequest,
      com.example.testrestapi.CreateAnimalPartTypeResponse> getCreateAnimalPartTypeServiceMethod() {
    io.grpc.MethodDescriptor<com.example.testrestapi.CreateAnimalPartTypeRequest, com.example.testrestapi.CreateAnimalPartTypeResponse> getCreateAnimalPartTypeServiceMethod;
      ...
      synchronized (AnimalPartTypeServiceGrpc.class) {
        if ((getCreateAnimalPartTypeServiceMethod = AnimalPartTypeServiceGrpc.getCreateAnimalPartTypeServiceMethod) == null) {
          AnimalPartTypeServiceGrpc.getCreateAnimalPartTypeServiceMethod = getCreateAnimalPartTypeServiceMethod =
              io.grpc.MethodDescriptor.<com.example.testrestapi.CreateAnimalPartTypeRequest, com.example.testrestapi.CreateAnimalPartTypeResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "createAnimalPartTypeService"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.testrestapi.CreateAnimalPartTypeRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.testrestapi.CreateAnimalPartTypeResponse.getDefaultInstance()))
  ...
  public static abstract class AnimalPartTypeServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getAnimalPartTypeService(com.example.testrestapi.GetAnimalPartTypeRequest request,
        io.grpc.stub.StreamObserver<com.example.testrestapi.GetAnimalPartTypeResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetAnimalPartTypeServiceMethod(), responseObserver);
    }

    /**
     */
    public void createAnimalPartTypeService(com.example.testrestapi.CreateAnimalPartTypeRequest request,
        io.grpc.stub.StreamObserver<com.example.testrestapi.CreateAnimalPartTypeResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.example.testrestapi.GetAnimalPartTypeRequest,
                com.example.testrestapi.GetAnimalPartTypeResponse>(
                  this, METHODID_GET_ANIMAL_PART_TYPE_SERVICE)))
          .addMethod(
            getCreateAnimalPartTypeServiceMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.example.testrestapi.CreateAnimalPartTypeRequest,
                com.example.testrestapi.CreateAnimalPartTypeResponse>(
  ...
  public static final class AnimalPartTypeServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AnimalPartTypeServiceBlockingStub> {
    ...
    /**
     */
    public com.example.testrestapi.GetAnimalPartTypeResponse getAnimalPartTypeService(com.example.testrestapi.GetAnimalPartTypeRequest request) {
    ...
    /**
     */
    public com.example.testrestapi.CreateAnimalPartTypeResponse createAnimalPartTypeService(com.example.testrestapi.CreateAnimalPartTypeRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class AnimalPartTypeServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AnimalPartTypeServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.testrestapi.GetAnimalPartTypeResponse> getAnimalPartTypeService(
        com.example.testrestapi.GetAnimalPartTypeRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.testrestapi.CreateAnimalPartTypeResponse> createAnimalPartTypeService(
        com.example.testrestapi.CreateAnimalPartTypeRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_ANIMAL_PART_TYPE_SERVICE:
          serviceImpl.getAnimalPartTypeService((com.example.testrestapi.GetAnimalPartTypeRequest) request,
              (io.grpc.stub.StreamObserver<com.example.testrestapi.GetAnimalPartTypeResponse>) responseObserver);
          break;
        case METHODID_CREATE_ANIMAL_PART_TYPE_SERVICE:
          serviceImpl.createAnimalPartTypeService((com.example.testrestapi.CreateAnimalPartTypeRequest) request,
              (io.grpc.stub.StreamObserver<com.example.testrestapi.CreateAnimalPartTypeResponse>) responseObserver);
          break;
        default:
